<template>
  <div class="preview-block">
    <div class="preview-header">
      ...
      <div class="extra">
        <f-button type="text" icon="el-icon-video-play" @click="handleRun">
          运行
        </f-button>
        <f-button type="text" icon="el-icon-refresh" @click="handleReset">
          清空
        </f-button>
        <f-button type="text" icon="el-icon-download" @click="handleSave">
          保存
        </f-button>
      </div>
    </div>
